...
![Arquitectura del API](https://github.com/JohnHeiller/PropertiesUS/blob/master/DocumentedImages/1_Diagrama_arquitectura.png)
...
![Estructura de Controladores](https://github.com/JohnHeiller/PropertiesUS/blob/master/DocumentedImages/2_Estructura_Controladores.png)
...
![Estructura de BL](https://github.com/JohnHeiller/PropertiesUS/blob/master/DocumentedImages/2_Estructura_BL.png)
...
![Estructura de DAL](https://github.com/JohnHeiller/PropertiesUS/blob/master/DocumentedImages/2_Estructura_DAL.png)
...
![Estructura de DTO](https://github.com/JohnHeiller/PropertiesUS/blob/master/DocumentedImages/2_Estructura_DTO.png)
...
![Documentación con Swagger](https://github.com/JohnHeiller/PropertiesUS/blob/master/DocumentedImages/3_Documentacion_Swagger.png)
...
## 5. PRUEBAS UNITARIAS
Se crea el proyecto de pruebas unitarias _API.PropertiesUS.Test_ con _NUnit_, probando los métodos de las clases en _BL_ mediante casos de pruebas preestablecidos.
![Proyecto de pruebas unitarias](https://github.com/JohnHeiller/PropertiesUS/blob/master/DocumentedImages/5_Pruebas_Unitarias.png)
...
![Seguridad con Autenticación](https://github.com/JohnHeiller/PropertiesUS/blob/master/DocumentedImages/6_Seguridad_Autenticacion.png)
...
- Una vez configurada la base de datos puede dejar la parametrización de la cadena de conexión para que se obtenga desde una variable de entorno. ![Configuración conexión a API](https://github.com/JohnHeiller/PropertiesUS/blob/master/DocumentedImages/8_2_Usar_Cadena_BD.png)
...
![Parámetro APIConnection](https://github.com/JohnHeiller/PropertiesUS/blob/master/DocumentedImages/8_3_APIConnection.png)

- Finalmente, puede ejecutar el proyecto para visualizar la exposición de los servicios creados. ![Autenticación en Swagger](https://github.com/JohnHeiller/PropertiesUS/blob/master/DocumentedImages/8_4_Authorize_Swagger.png)
Recuerde que, para hacer una petición a uno de estos servicios, primero debe autenticarse. 
![Uso de credenciales de acceso en Swagger](https://github.com/JohnHeiller/PropertiesUS/blob/master/DocumentedImages/8_5_Credenciales_Autenticacion.png)
Y las credenciales de acceso están parametrizadas en el archivo _appsettings.json_. 
![Parametrización de credenciales de acceso de API](https://github.com/JohnHeiller/PropertiesUS/blob/master/DocumentedImages/8_6_Parametrizacion_Credenciales.png)
...
![Prueba de servicios en Swagger](https://github.com/JohnHeiller/PropertiesUS/blob/master/DocumentedImages/8_7_Servicios_Swagger.png)
